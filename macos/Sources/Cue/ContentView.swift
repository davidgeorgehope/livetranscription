    ...
    private var briefPopover: some View {
        VStack(alignment: .leading, spacing: 10) {
            Text("Ask Grok Bot for a pre-call brief")
                .font(.headline)
            Text("Leave blank for your next calendar meeting, or say who it's with — company, people, agenda.")
                .font(.caption)
                .foregroundStyle(.secondary)
            TextField("Next meeting on my calendar", text: $briefTopic, axis: .vertical)
                .lineLimit(2...4)
                .textFieldStyle(.roundedBorder)
...
struct SettingsView: View {
    ...
    private var settingsForm: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("Cue watches which app holds the microphone — Zoom, Teams, Chrome for Meet. When it lets go, or the brief's scheduled end has passed and the room is quiet, Cue stops and writes the wrap.")
                .font(.caption)
                .foregroundStyle(.secondary)
